/**
 * PrivacyPanel — sidebar version of privacy disclosure for desktop two-column layout.
 * Same content as PrivacyBanner but styled as a sticky sidebar panel.
 * Rendered in the 35% right column on desktop, below form sections on mobile.
 *
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        <div>
          <h3 className="text-xs font-semibold text-text-label mb-1">
            What we store
          </h3>
